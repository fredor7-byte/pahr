...
const mockOrder = {
  ...
  shipping_address: {
    street: "Av. Libertador, Edif. Torre A, Piso 5, Apto 5B",
    city: "Caracas",
    state: "Distrito Capital",
    reference: "Cerca del CC Sambil",
  },
  items: [
    { product_name: "Polo Heritage", variant_desc: "Blanco / M", quantity: 1, unit_price_usd: 38.00 },
    { product_name: "Hoodie Forest Classic", variant_desc: "Verde Bosque / L", quantity: 1, unit_price_usd: 45.00 },
  ],
  subtotal_usd: 83.00,
  total_usd: 83.00,
  exchange_rate_snapshot: 36.50,
  total_bs: 3029.50,
  payment_proof: {
    reference_number: "1234567890",
    declared_amount: 3029.50,
    declared_currency: "VES",
    image_url: null,
  },
  notes: null,
  admin_notes: "",
...
export default function PedidoDetailPage({
  ...
  const expectedBs = order.total_usd * order.exchange_rate_snapshot;
  const declaredAmount = order.payment_proof.declared_amount;
  const amountMatch =
      ...
      <div className="grid md:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-lg border border-charcoal-200 p-5 space-y-3">
          ...
          <div className="text-sm space-y-1">
            ...
            <p className="text-charcoal-500">{order.customer.email}</p>
            <p className="text-charcoal-500">{order.customer.phone}</p>
            <p className="text-charcoal-500">{order.customer.cedula}</p>
          </div>
        </div>
      ...
      <div className="bg-white rounded-lg border border-charcoal-200 p-5">
        ...
        <div className="space-y-2">
          {order.items.map((item, i) => (
            <div key={i} className="flex justify-between text-sm p-2 bg-charcoal-50 rounded">
              <div>
        ...
        <div className="border-t border-charcoal-200 mt-3 pt-3 space-y-1">
          ...
          <div className="flex justify-between text-sm">
            ...
            <span>{order.exchange_rate_snapshot} Bs/$</span>
          </div>
      ...
      <div className="bg-white rounded-lg border-2 border-gold-300 p-5 space-y-4">
        ...
        <div className="grid md:grid-cols-2 gap-4">
          <div className="space-y-3">
            ...
            <div className="text-sm">
              ...
              <span className="font-mono font-medium">
                {order.payment_proof.reference_number}
              </span>
            </div>
            <div className="text-sm">
              <span className="text-charcoal-500">Monto declarado: </span>
              <span className="font-medium">
                {order.payment_proof.declared_currency === "VES"
          ...
          <div>
            ...
            <div className="aspect-[3/4] bg-charcoal-100 rounded-lg flex items-center justify-center">
        ...
        {order.status === "pendiente" && (
          <div className="border-t border-charcoal-200 pt-4 space-y-3">
            ...
            <div className="flex gap-3">
              <Button
                className="flex-1"
                onClick={() => alert("Pago aprobado (mock)")}
              >
              ...
              <Button
                variant="danger"
                className="flex-1"
                onClick={() => alert("Pago rechazado (mock)")}
              >
